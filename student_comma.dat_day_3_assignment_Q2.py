...
file_path = 'C:/Users/ashish.kumar1/PycharmProjects/pythonProject/student_comma.dat'
file_name1 = os.path.basename(file_path)
file_size = os.path.getsize('C:/Users/ashish.kumar1/PycharmProjects/pythonProject/student_comma.dat')
