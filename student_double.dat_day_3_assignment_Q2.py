...
file_path = 'C:/Users/ashish.kumar1/PycharmProjects/pythonProject/student_double_semi.dat'
modification_time = os.path.getmtime(file_path)
dt_modification = datetime.datetime.fromtimestamp(modification_time)

file_name1 = os.path.basename(file_path)
file_size = os.path.getsize('C:/Users/ashish.kumar1/PycharmProjects/pythonProject/student_double_semi.dat')

file_name = "student_double_semi.dat"
